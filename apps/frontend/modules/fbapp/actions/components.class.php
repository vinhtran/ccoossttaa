 ...
 *
 */
class fbappComponents extends sfComponents
{
	/** 
	 * Footer component
	...
	public function executeShareBlock(sfWebRequest $request)
	{
	  $this->facebookVars = array(
  		...
  		'caption' => 'Nokia Lumia puzzle code',
	  ...
	  */
	  $twitterVars = array(
  		...
  		// 	    'data-via' => 'your_screen_name',
  		'text' => 'Le dernier Nokia Lumia 800 ? A gagner sur la page Orange Caraïbe, ici :'.sfConfig::get('app_facebookApp_userLocale'),
  		// 	    'data-related' => 'fr',
	 ...
	 * @param sfWebRequest $request
	 */
	public function executeTopPlayers(sfWebRequest $request)
	{
	  $this->topPlayers = CodesTable::getTopPlayers();
// 	  var_dump($this->topPlayers);die;
	}
	 ...
	 * @param sfWebRequest $request
	 */
	public function executeInviteBlock(sfWebRequest $request)
	{
